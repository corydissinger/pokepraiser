...
public class AttackNameArrayAdapter extends ArrayAdapter<AttackInfo> {
	...
	public AttackNameArrayAdapter(Activity context, int textViewResourceId, List<AttackInfo> mAttacks) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			view 					= inflater.inflate(R.layout.attack_name_info_row, null);
			
			final ViewHolder viewHolder		= new ViewHolder();
			
			viewHolder.attackName			= (TextView) view.findViewById(R.id.attackName);
			
			((PokepraiserApplication)context.getApplication()).applyTypeface(new TextView[]{viewHolder.attackName});
