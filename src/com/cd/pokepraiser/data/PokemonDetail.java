...
public class PokemonDetail {
	...
	private Map<Integer, String> learnedTypeToAttackNameMap;
	...
	public Map<Integer, String> getLearnedTypeToAttackNameMap() {
		return learnedTypeToAttackNameMap;
	}
	public void setLearnedTypeToAttackNameMap(
			Map<Integer, String> learnedTypeToAttackNameMap) {
		this.learnedTypeToAttackNameMap = learnedTypeToAttackNameMap;
	}
	...
	public String toString() {
		...
		builder.append(pokemonId);
		builder.append(", learnedTypeToAttackNameMap=");
		builder.append(learnedTypeToAttackNameMap);
		builder.append("]");
